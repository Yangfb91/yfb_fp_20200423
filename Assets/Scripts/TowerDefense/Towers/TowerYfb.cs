...
namespace TowerDefense.Towers
{
	...
	/// </summary>
	public class TowerYfb : Targetable
	{
		/// <summary>
		/// The tower levels associated with this tower
		/// </summary>
		public TowerLevelYfb[] levels;
		...
		/// </summary>
		public TowerLevelYfb currentTowerLevel { get; protected set; }
		...
		public virtual void Initialize(IPlacementArea targetArea, IntVector2 destination)
		{
            ...
            {
                LevelManagerYfb.instance.levelStateChanged += OnLevelStateChanged;
            }
        }
		...
		public int GetSellLevel(int level)
		{
			...
			if (LevelManagerYfb.instance.levelState == LevelState.Building)
			{
				int cost = 0;
		...
		protected void SetLevel(int level)
		{
            ...
            //// disable affectors
            LevelState levelState = LevelManagerYfb.instance.levelState;

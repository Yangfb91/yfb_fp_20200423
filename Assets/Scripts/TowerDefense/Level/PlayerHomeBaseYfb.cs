...
namespace TowerDefense.Level
{
	...
	/// </summary>
	public class PlayerHomeBaseYfb : DamageableBehaviour
	{
		/// <summary>
		...
		/// </summary>
		protected List<AgentYfb> m_CurrentAgentsInside = new List<AgentYfb>();
		...
		{
			var homeBaseAttacker = other.GetComponent<HomeBaseAttackerYfb>();

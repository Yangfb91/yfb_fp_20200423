...
namespace TowerDefense.Level
{
	...
	/// </summary>
	public class WaveYfb : TimedBehaviour
	{
		/// <summary>
		/// A list of instructions on how to spawn enemies
		/// </summary>
		public List<SpawnInstructionYfb> spawnInstructions;
		...
		{
			SpawnInstructionYfb spawnInstruction = spawnInstructions[m_CurrentIndex];
		...
		protected bool TrySetupNextSpawn()
		{
			...
			if (hasNext)
			{
				SpawnInstructionYfb nextSpawnInstruction = spawnInstructions[m_CurrentIndex];

...
namespace TowerDefense.Agents
{
	...
	/// </summary>
	public class FlyingAgentYfb : AgentYfb
	{
		/// <summary>
		...
		/// <summary>
		/// Controls behaviour based on the states <see cref="AgentYfb.State.OnCompletePath"/>, <see cref="Agent.State.OnPartialPath"/> 
		/// and <see cref="AgentYfb.State.PushingThrough"/>
		/// </summary>
		...
		/// clear the gap and turn on their agent once time elapses
		/// </summary>

...
namespace TowerDefense.Agents
{
	...
	/// </summary>
	public class AttackingAgentYfb : AgentYfb
	{
		/// <summary>
		/// Tower to target
		/// </summary>
		//protected TowerYfb m_TargetTower;
		...
		//protected TowerYfb GetClosestTower()
		//{
		//	var towerController = m_AttackAffector.towerTargetter.GetTarget() as TowerYfb;
		...
		/// <summary>
		/// Peforms the relevant path update for the states <see cref="AgentYfb.State.OnCompletePath"/>, 
		/// <see cref="AgentYfb.State.OnPartialPath"/> and <see cref="AgentYfb.State.Attacking"/>
		/// </summary>
